				...
				<div class="panel-body panel-body-inputin">
					<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('project/processEdit');?>">
						...
						<div class="form-group has-warning">
						    ...
						    <input type="text" id="start_date" class="form-control1 input-lg" name="start_date" value="<?php echo date('d-m-Y', strtotime($project->start_date))?>"></p>
						</div>

						<div class="form-group has-warning">
							<label class="control-label" for="inputWarning1">Sampai Tanggal</label>
						    <input type="text" id="end_date" class="form-control1 input-lg" name="end_date" value="<?php echo date('d-m-Y', strtotime($project->end_date))?>"></p>
						</div>
