							...
							<?php if($project->created_by == $this->session->userdata('id')){?>
								<div class="dropdown float-right">
									...
									<div class="dropdown-menu dropdown-scale dropdown-menu-right" role="menu" style="position: absolute; transform: translate3d(-136px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
										<a class="dropdown-item" href="<?php echo base_url('upcoming/edit/' . $project->id_project);?>">Edit</a>
										<a class="dropdown-item" href="<?php echo base_url('upcoming/delete/' . $project->id_project . '/' . $project->id_product);?>">Delete</a>
									</div>
								</div><!--/ dropdown -->
							<?php } ?>
