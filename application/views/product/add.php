...
<section>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="graphs">
				<h3 class="blank1">Add Data Product</h3>
				<div class="panel-body panel-body-inputin">
					<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('product/processAdd');?>">
					    ...
					    <div class="form-group has-warning">
					        ...
					        <textarea class="form-control1" name="description" rows="25" cols="25" required></textarea>
					    </div>
