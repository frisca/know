...
<section>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="graphs">
				<h3 class="blank1">Add Data FAQ</h3>
				<div class="panel-body panel-body-inputin">
					<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('faq/processAdd');?>">
						...
						<div class="form-group has-warning">
					        ...
					        <textarea cols="80" id="edi" name="question" rows="10" required></textarea>
					    </div>
					    <div class="form-group has-warning">
					        <label class="control-label" for="inputWarning1">Anwser</label>
					        <textarea cols="80" id="edi2" name="answer" rows="10" required></textarea>
					    </div>
