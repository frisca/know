		...
		<div id="page-wrapper">
			<div class="graphs">
				...
				<div class="panel-body panel-body-inputin">
					<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('release/processNonreleaseedit');?>">
					    ...
					    <a href="<?php echo base_url('release/nonrelease/' . $project->id_project);?>">
