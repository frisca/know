		...
		<div id="page-wrapper">
			<div class="graphs">
				...
				<div class="panel-body panel-body-inputin">
					<form role="form" class="form-horizontal" method="post" action="<?php echo base_url('ongoing/processEdit');?>">
					    ...
					    <a href="<?php echo base_url('ongoing/detail/' . $project->id_project);?>">
